...
- (void)loadLaunchImage:(NSString *)imgName
	...
	if (bgName.length != 0) {
        ...
        self.bgImage.image = [UIImage imageNamed:imgName];
        //self.bgImage.image = [[UIImage alloc] initWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:bgName]]];
	}
	...
	if (imgName.length != 0) {
		...
		//self.launchimage.image = [[UIImage alloc] initWithData:[NSData dataWithContentsOfURL:[NSURL URLWithString:bgName]]];
	}
