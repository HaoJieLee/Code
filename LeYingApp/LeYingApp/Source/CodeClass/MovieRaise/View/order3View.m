...
-(void)p_SetupUI
{
    ...
    //顶部背景
    self.topView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, CGRectGetWidth(self.frame), CGRectGetHeight(self.frame))];
    ...
    //详情
    self.detailWeb = [[UIWebView alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.titLab.frame) + 4, CGRectGetWidth(self.frame) - 20, KScreenH - CGRectGetMaxY(self.topPic.frame) - 178)];
    //    self.detailLab.numberOfLines = 0;
    [self.topView addSubview:_detailWeb];
    
    
    self.btnShowDetail = [[UIButton alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.detailWeb.frame) - 80, CGRectGetMaxY(self.detailWeb.frame) + 3 - 2, 60, 20)];
...
//    
//    //价格设置
//    self.priceLab = [[UILabel alloc]initWithFrame:CGRectMake(10,10, CGRectGetWidth(self.frame)/ 2, 30)];
...
//    
//    //收货人
//    self.consigneeLab = [[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.priceLab.frame) + 10, 50, 30)];
//    self.consigneeLab.font = [UIFont systemFontOfSize:15];
...
//    
//    //手机号
//    self.phoneLab = [[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.consigneeLab.frame) + 5, 50, 30)];
...
//    //留言
//    
//    self.messageText = [[UITextView alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.addressLab.frame) + 5, CGRectGetWidth(self.frame) - 20, 60)];
//    
//    
//    
//    
...
//    self.playholdLab =[[UILabel alloc]initWithFrame:CGRectMake(10, CGRectGetMaxY(self.addressLab.frame) + 5, CGRectGetWidth(self.frame) - 20, 20)];
...
//    self.showMassageLab.font = [UIFont systemFontOfSize:13];
//    
//    [self.bottomView addSubview:_showMassageLab];
//    
//    self.totalLab = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetWidth(self.frame) -95 , CGRectGetMinY(self.showMassageLab.frame), 40, 20)];
...
//    
//    
//    self.allLab = [[UILabel alloc]initWithFrame:CGRectMake(CGRectGetWidth(self.frame) -55 , CGRectGetMinY(self.showMassageLab.frame), 50, 20)];
//    self.allLab .font = [UIFont systemFontOfSize:13];
