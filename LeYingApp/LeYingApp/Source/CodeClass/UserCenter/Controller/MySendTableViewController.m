...
@interface MySendTableViewController ()
@property (nonatomic,strong)NSArray *myArr3;
@end

@implementation MySendTableViewController
...
- (void)viewDidLoad {
    ...
    [[getAboutOrder shareDataOrder] getOrderWithPage:@"1" Pagesize:@"10" Paybackid:@"1" Status:@"8" ProjectId:@"1" Token:avi WithOrderValue:^(NSArray *orderArr) {
        
        self.myArr3 = orderArr;
