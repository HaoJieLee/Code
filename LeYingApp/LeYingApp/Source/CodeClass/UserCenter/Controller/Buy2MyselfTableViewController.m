//
//  Buy2MyselfTableViewController.m
//  乐影
//
...
#import "TestModel.h"
#import "orderModer.h"
@interface Buy2MyselfTableViewController ()
...
@implementation Buy2MyselfTableViewController
...
- (void)viewDidLoad {
    ...
    else
    {
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            [self getArtcollectWithState:@"1"Page:@"1"];
...
- (void)footerRereshing
{
    ...
    else
    {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
            [self getArtcollectWithState:@"1"Page:[NSString stringWithFormat:@"%ld",(long)self.index++]];
            dispatch_async(dispatch_get_main_queue(), ^{
                // 刷新表格
                [self.tableView reloadData];
