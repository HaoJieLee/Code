...
- (void)viewDidLoad {
    ...
    self.txtFieldName.placeholder = @"请输入器材";
    ...
    self.txtFieldName.text = _strQicai;
}
...
-(void)rightBarButtonAction
{
    ...
    {
        [AlertShow alertShowWithContent:@"器材不能为空" Seconds:3];
    }
    else
    {
        // 保存 反向传值
