...
@interface GonglingViewController ()

@end

@implementation GonglingViewController
...
- (void)viewDidLoad {
    ...
    self.txtFieldName.placeholder = @"请输入工龄";
    ...
    self.txtFieldName.text = _strGongling;
}
