...
@implementation PicUploadNewCollectionViewCell
...
-(UIImageView *)imgCategory
{
    if (_imgCategory == nil) {
        CGFloat padding = 0;
        self.imgCategory = [[UIImageView alloc] initWithFrame:CGRectMake(padding, padding, (CGRectGetWidth(self.frame)) - padding * 2, 154 + 4)];
